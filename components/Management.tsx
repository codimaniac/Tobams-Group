...
const Management = () => {
  return (
    <SectionLayout className="bg-background py-16 text-white">
        <div className="flex gap-12 bg-purple-80 p-5 lg:p-10 rounded-[20px]">
            <div className="not-xl:hidden relative flex-1 aspect-square overflow-hidden rounded-lg rounded-br-none">
                <Image src={ManagementImage} alt="A seasoned professional coaching a trainee" fill className="object-cover" />
            </div> 
            <div className="flex flex-col flex-1 gap-5">
                <h2 className="font-nunito font-semibold text-[clamp(20px,3vw,40px)] tracking-[3%]">Management Development Program</h2>
                <div className="xl:hidden relative flex-1 aspect-square overflow-hidden rounded-lg rounded-br-none">
                    <Image src={ManagementImage} alt="A seasoned professional coaching a trainee" fill className="object-cover" />
                </div> 
                <div className="flex flex-col gap-5 text-sm md:text-base leading-[150%]">
